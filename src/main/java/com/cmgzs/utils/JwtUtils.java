...
public class JwtUtils {
     ...
     * 签发者
     */
    public static final String ISSUER = "CMGZS";
    /**
     * 签名秘钥
     */
    ...
    public static String createJwtToken(String id, String issuer, String subject, long ttlMillis) {
        ...
        JwtBuilder builder = Jwts.builder().setId(id).setIssuedAt(now).setSubject(subject).setIssuer(issuer).setClaims(claims).signWith(signatureAlgorithm, signingKey);
